...
{
  id: "full-day-vip",
  name: "تصوير اليوم الكامل (VIP)",
  price: "اتصل للسعر",
  priceNote: "يتم تحديد السعر بناءً على تفاصيل اليوم ❤️",
  description: "اتصل لمناقشة تفاصيل اليوم وطريقة سيره",
  features: [
    "فريق محترف (2–3 مصورين) لتغطية كاملة من التجهيزات حتى آخر لحظة في الفرح",
    "تصوير فوتوغرافي احترافي بعدد غير محدود من الصور ووقت مفتوح",
    "برومو سينمائي يلخص اليوم بالكامل (رومانسي أو ترند حسب اختيارك)",
    ...
    "تسليم سريع خلال (1–4 أيام) عبر رابط خاص + فلاش ميموري",
...
export const pageTexts = {
  ...
  contact: {
    ...
    subtitle:
      "سيب بياناتك أو تواصل معانا مباشرة، وإحنا نهتم بالباقي.",
