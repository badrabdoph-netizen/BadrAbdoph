...
export const weddingPackages = [
  {
    ...
    features: [
      ...
      "مطبوعات مميزة بأحجام خاصة وبأسلوب Hand Made فاخر (يتم اختيارها أثناء الحجز من القائمة المتاحة)",
  ...
  },
  {
    ...
    features: [
      ...
      "أولوية تسليم سريع",
      "مطبوعات",
      "ألبوم أكريليك (30 صورة)",
      "تابلوه Large مقاس 50×70",
      "تابلوه Medium مقاس 40×50",
      "ألبوم Mini صغير أو كروت صور صغيرة",
      "هدية",
    ],
    popular: false,
  },
