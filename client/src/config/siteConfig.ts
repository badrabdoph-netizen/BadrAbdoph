...
export const weddingPackages = [
  {
    id: "FULL DAT VIP",
    name: "تصوير اليوم الكامل ",
    price: "اتصل للسعر",
    priceNote: "يتم تحديد السعر بنائا علي تفاصيل اليوم ❤️",
    description: "اتصل لمناقشه تفاصيل اليوم وطريقه سيره",
features: [
  "فريق محترف (2–5 مصورين) لتغطية كاملة من التجهيزات حتى آخر لحظة في الفرح",
  ...
  "ترتيب مسبق قبل يوم الزفاف واهتمام كامل بتفاصيل اليوم",
