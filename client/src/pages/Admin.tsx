...
export default function Admin() {
  const { user, loading: authLoading, isAuthenticated, logout } = useAuth({ redirectOnUnauthenticated: false });
...
const handleLogin = async () => {
  try {
    ...
    // Reload to re-fetch auth state and admin data safely
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>ادخل كلمة المرور للدخول</CardDescription>
        </CardHeader>
