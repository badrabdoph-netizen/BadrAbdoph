    ...
    <div className="min-h-screen bg-background text-foreground" style={{ fontFamily: "'Cairo', sans-serif" }}>
      ...
      <header className="pt-40 pb-20 bg-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700" style={{ fontFamily: "'Amiri', serif" }}>{aboutContent.subtitle}</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 text-right">
              <h2 className="text-3xl md:text-4xl font-bold text-primary" style={{ fontFamily: "'Amiri', serif" }}>{photographerInfo.name}</h2>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16" style={{ fontFamily: "'Amiri', serif" }}>لماذا تختارني؟</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background p-8 border border-white/5 hover:border-primary/50 transition-colors duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-primary" style={{ fontFamily: "'Amiri', serif" }}>أسلوب سينمائي</h3>
            ...
            <div className="bg-background p-8 border border-white/5 hover:border-primary/50 transition-colors duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-primary" style={{ fontFamily: "'Amiri', serif" }}>تجربة مريحة</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-background p-8 border border-white/5 hover:border-primary/50 transition-colors duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-primary" style={{ fontFamily: "'Amiri', serif" }}>جودة لا تضاهى</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20 text-center">
        <h2 className="text-3xl font-bold mb-8" style={{ fontFamily: "'Amiri', serif" }}>هل أعجبك أسلوبي؟</h2>
        <Link href="/contact">
