    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden" style={{ fontFamily: "'Cairo', sans-serif" }}>
      ...
      <header className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 container mx-auto px-4 text-center flex flex-col items-center">
          <h2 className="text-primary tracking-[0.3em] mb-4">{photographerInfo.title}</h2>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6" style={{ fontFamily: "'Amiri', serif" }}>
            توثيق <span className="text-primary italic">المشاعر</span><br />واللحظات الحقيقية
          </h1>
          <p className="text-gray-300 max-w-2xl mb-10">{photographerInfo.descriptionAr}</p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/contact">
              <Button size="lg" className="bg-primary rounded-none px-8 py-6">
                {ctaTexts.bookSession}
              </Button>
            </Link>
            <Link href="/portfolio">
              <Button variant="outline" size="lg" className="border-white text-white rounded-none px-8 py-6">
      ...
      {/* ✅ Services Preview (Moved Here) */}
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h3 className="text-primary mb-2">الخدمات</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card p-8 border">
              <Camera className="text-primary mb-4" />
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <img src={siteImages.aboutImage} className="w-full h-[500px] object-cover" />
          <div className="text-right">
            ...
            <Link href="/about">
              <Button variant="link">{ctaTexts.readMore} <ArrowLeft /></Button>
            </Link>
          </div>
        </div>
      </section>
