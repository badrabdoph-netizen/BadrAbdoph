...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden" style={{ fontFamily: "'Cairo', sans-serif" }}>
      <Navbar />
      ...
      <header className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 container mx-auto px-4 text-center flex flex-col items-center animate-in fade-in zoom-in duration-1000">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/contact">
              <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg rounded-none min-w-[180px]">
                {ctaTexts.bookSession}
              </Button>
            </Link>
            <Link href="/portfolio">
              <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-black px-8 py-6 text-lg rounded-none min-w-[180px]">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2 text-right">
              <h3 className="text-primary text-sm tracking-widest uppercase mb-2 font-bold">{aboutContent.subtitle}</h3>
              <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: "'Amiri', serif" }}>{aboutContent.title}</h2>
      ...
      <section className="py-24 bg-card overflow-hidden">
        <div className="container mx-auto px-4 mb-12 flex justify-between items-end">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold" style={{ fontFamily: "'Amiri', serif" }}>لقطات مختارة</h2>
          </div>
          <Link href="/portfolio">
            <Button variant="outline" className="hidden md:flex border-white/20 hover:bg-white hover:text-black rounded-none">
              عرض المعرض الكامل
            </Button>
          </Link>
        </div>
        ...
        <div className="flex space-x-6 space-x-reverse overflow-x-auto pb-8 px-4 md:px-0 scrollbar-hide">
          {siteImages.portfolioPreview.map((item, index) => (
            <div key={index} className="min-w-[300px] md:min-w-[400px] h-[500px] relative group cursor-pointer overflow-hidden">
              <img 
                src={item.src} 
                alt={item.title} 
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <h4 className="text-2xl text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-500" style={{ fontFamily: "'Amiri', serif" }}>{item.title}</h4>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold" style={{ fontFamily: "'Amiri', serif" }}>باقات التصوير</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card p-8 border border-white/5 hover:border-primary/30 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: "'Amiri', serif" }}>جلسات التصوير</h3>
              ...
              <ul className="text-sm text-muted-foreground space-y-2 mb-8">
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> عدد صور غير محدود</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> شامل 2 Reels & TikTok</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> تعديل احترافي</li>
              </ul>
            </div>

            <div className="bg-card p-8 border border-primary/20 relative transform md:-translate-y-4 shadow-2xl shadow-black/50">
              <div className="absolute top-0 right-0 bg-primary text-primary-foreground text-xs font-bold px-3 py-1">الأكثر طلباً</div>
              <Heart className="w-12 h-12 text-primary mb-6" />
              <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: "'Amiri', serif" }}>باقات الزفاف</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                تغطية شاملة ليوم الزفاف من التحضيرات حتى نهاية الحفل، لتوثيق كل لحظة وكل تفصيل.
              </p>
              <ul className="text-sm text-muted-foreground space-y-2 mb-8">
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> ألبومات فاخرة مطبوعة</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> تابلوهات خشبية</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> تغطية فيديو Reels</li>
              </ul>
            </div>

            <div className="bg-card p-8 border border-white/5 hover:border-primary/30 transition-all duration-300 group">
              <Star className="w-12 h-12 text-primary mb-6 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: "'Amiri', serif" }}>VIP Full Day</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                تجربة تصوير كاملة بمستوى VIP ليوم لا يتكرر، مع فريق عمل متكامل واهتمام بأدق التفاصيل.
              </p>
              <ul className="text-sm text-muted-foreground space-y-2 mb-8">
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> تغطية يوم كامل</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> فيديو برومو سينمائي</li>
                <li className="flex items-center"><Star size={14} className="ml-2 text-primary" /> هدايا حصرية</li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/services">
              <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground rounded-none px-8">
      ...
      <section className="py-24 bg-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-16" style={{ fontFamily: "'Amiri', serif" }}>قصص سعيدة</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-background/50 p-8 border border-white/5 backdrop-blur-sm">
                <div className="text-primary text-4xl font-serif mb-4">"</div>
                <p className="text-lg text-muted-foreground mb-6 italic">
                  {testimonial.quote}
                </p>
                <h4 className="font-bold text-foreground" style={{ fontFamily: "'Amiri', serif" }}>{testimonial.name}</h4>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 relative flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6" style={{ fontFamily: "'Amiri', serif" }}>{pageTexts.home.ctaTitle}</h2>
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            {pageTexts.home.ctaDescription}
          </p>
          <Link href="/contact">
            <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-8 text-xl rounded-none min-w-[200px]">
              {ctaTexts.contactNow}
            </Button>
          </Link>
        </div>
